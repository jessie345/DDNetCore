 ...
 */
public class RefreshCacheForList<T> extends ListGetStrategy<T> {
    private MemoryStorage mMemoryDataPool;

    public RefreshCacheForList(@NonNull Class<T> dataClass, @NonNull Call<JsonObject> call, @Nullable ResponseListener<List<T>> listener) {
