 ...
 */
public class Level3CacheForArray<T> extends ArrayGetStrategy<T> {
    private MemoryStorage mMemoryDataPool;

    public Level3CacheForArray(@NonNull Class<T> dataClass, @NonNull Call<JsonObject> call, @Nullable ResponseListener<T[]> callback) {
    ...
    public void fetchData() {
        ...
        if (data != null && data.size() > 0) {
            ...
            notifyCacheSuccess(dataArr, true);
