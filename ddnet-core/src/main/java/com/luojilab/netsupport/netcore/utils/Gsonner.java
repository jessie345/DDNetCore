...
public class Gsonner {
    ...
    public JsonArray getJsonArray(@NonNull String key) {
        ...
        if (jsonElement == null || !(jsonElement instanceof JsonArray)) {
            NetLogger.w(NetLogger.TAG, String.format("Illegal jsonArray element of key! element=%1$s,key=%2$s", jsonElement, key));
            return null;
        }
    ...
    public JsonObject getJsonObject(@NonNull String key) {
        ...
        if (jsonElement == null || !(jsonElement instanceof JsonObject)) {
            NetLogger.w(NetLogger.TAG, String.format("Illegal jsonObject element of key! element=%1$s,key=%2$s", jsonElement, key));
            return null;
        }
    ...
    public JsonPrimitive getJsonPrimitive(@NonNull String key) {
        ...
        if (jsonElement == null || !(jsonElement instanceof JsonPrimitive)) {
            NetLogger.w(NetLogger.TAG, String.format("Illegal JsonPrimitive element of key! element=%1$s,key=%2$s", jsonElement, key));
            return null;
        }
