...
public class ProductAddActivity extends BaseActivity {
    ...
    public static void intentTo(Context contex) {
        Intent intent = new Intent(contex, ProductAddActivity.class);
        ...
        mBinding.btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(brief)) {
                    Toast.makeText(ProductAddActivity.this, "缺少必要信息", Toast.LENGTH_SHORT);
                    return;
                }
    ...
    public void handleNetRequestError(@NonNull Request request, @NonNull ResponseHeader rb) {
        Toast.makeText(ProductAddActivity.this, rb.getMessage(), Toast.LENGTH_SHORT).show();
